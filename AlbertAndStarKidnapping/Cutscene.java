...
public class Cutscene extends World
{
    ...
    private static GreenfootImage jayjay = new GreenfootImage("images/cutscene/dvalin2.png");
    ...
    public void scene8()
    {
        ...
        textBox8.addText("*End of story*\n*There will now be infinite levels*", player);
    }
}
